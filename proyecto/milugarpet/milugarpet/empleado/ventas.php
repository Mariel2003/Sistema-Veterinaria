...
<head>
    ...
    <title>Ventas - Mi Lugar Pet</title>
        ...
        <main class="employee-main">
            <div class="employee-content">
                <div class="page-header">
                    ...
                    <p>Administra las ventas y pedidos</p>
                </div>
        ...
        function displayPedidoDetails(pedido, detalles) {
                ...
                detalles.forEach(detalle => {
                    ...
                    detallesHtml += `
                        <tr>
                            ...
                            <td>
                                <span class="precio-unitario">$${parseFloat(detalle.precio_unitario).toFixed(2)}</span>
                            </td>
                            <td>
            ...
            const modalContent = `
                ...
                <div class="total-pedido">
                    <h4>Total del Pedido: $${parseFloat(pedido.total).toFixed(2)}</h4>
                </div>
            `;
