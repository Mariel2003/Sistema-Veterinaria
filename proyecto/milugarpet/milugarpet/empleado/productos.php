...
if (isset($_GET['stock_bajo'])) {
    $where_clause = "WHERE stock <= 5";
}

$consulta = $conexion->query("SELECT * FROM productos $where_clause ORDER BY id_producto DESC");
$productos = [];
if ($consulta) {
                ...
                <div class="table-card">
                    <div class="card-header">
                        ...
                        <div class="header-actions">
                            <a href="productos.php?stock_bajo=1" class="filter-btn <?php echo isset($_GET['stock_bajo']) ? 'active' : ''; ?>">
                                <i class="fas fa-exclamation-triangle"></i> Stock Bajo
                            </a>
                            <a href="productos.php" class="filter-btn <?php echo !isset($_GET['stock_bajo']) ? 'active' : ''; ?>">
